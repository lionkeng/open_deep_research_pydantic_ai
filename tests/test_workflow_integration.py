...
class TestWorkflowStage1Integration:
    ...
    @pytest.mark.asyncio
    async def test_workflow_high_confidence_brief_no_clarification(self, mock_api_keys):
    ...
    @pytest.mark.asyncio
    async def test_workflow_low_confidence_brief_with_clarification_interactive(self, mock_api_keys):
        ...
        with patch('open_deep_research_with_pydantic_ai.core.config.config') as mock_config:
            ...
            with patch('open_deep_research_with_pydantic_ai.agents.brief_generator.brief_generator_agent.generate_from_conversation', side_effect=brief_calls) as mock_brief:
                ...
                with patch('open_deep_research_with_pydantic_ai.agents.clarification.clarification_agent.should_ask_another_question', return_value=True):
                    with patch('open_deep_research_with_pydantic_ai.agents.clarification.clarification_agent.assess_query') as mock_clarify:
    ...
    @pytest.mark.asyncio
    async def test_workflow_low_confidence_brief_http_mode(self, mock_api_keys):
    ...
    @pytest.mark.asyncio
    async def test_workflow_question_limit_reached(self, mock_api_keys):
        ...
        with patch('open_deep_research_with_pydantic_ai.core.config.config') as mock_config:
            ...
            with patch('open_deep_research_with_pydantic_ai.agents.brief_generator.brief_generator_agent.generate_from_conversation') as mock_brief:
                ...
                # Mock clarification agent - should_ask_another_question returns False due to limit
                with patch('open_deep_research_with_pydantic_ai.agents.clarification.clarification_agent.should_ask_another_question', return_value=False):
...
class TestWorkflowResumeIntegration:
    ...
    @pytest.mark.asyncio
    async def test_resume_research_after_clarification(self, mock_api_keys):
...
class TestWorkflowErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_workflow_handles_brief_generation_error(self, mock_api_keys):
    ...
    @pytest.mark.asyncio
    async def test_workflow_handles_clarification_error(self, mock_api_keys):
